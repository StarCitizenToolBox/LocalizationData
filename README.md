...
## 4.8.2.PU.V1
1. 文本更新至4.8.2-live.12030094
2. 更正文本错误

## 4.8.1.PU.V2
1. 文本更新至4.8.1-live.11952564
...
## 4.7.2.PU.V1
1. 文本更新至4.7.2-live.11674325
2. 给所有导弹简写添加追踪信号描述

## 4.7.1.PU.V1
1. 文本更新至4.7.1-live.11592622
2. 修复部分文本格式问题
3. 更正采矿头提取功率补充文本
4. 保留部分新涂装译名到下次更新

## 4.7.0.PU.V2
1. 文本更新至4.7.0-live.11545720
2. 删除了一些不可见字符
3. 更新了极光 mk2 的涂装译名
4. 更正了霍夫斯泰德-S2的英文名
5. 更正了精炼面板的数值名称
...
## 4.7.0.PU.V1
1. 文本更新至4.7.0-live.11518367
2. 为所有地面载具导弹添加数据信息
3. 修复翻译问题，改进部分翻译文本
4. 更新雷达、护甲译名
5. 为防止矿石名遮挡飞船采矿界面的品质数值，删除所有原矿矿石的双语
6. 矿石精炼站精炼界面QTY更名为品质
7. 极光 MK II 涂装名译名等待后续版本更新

## 4.6.0.PU.V2
1. 文本更新至4.6.0-live.11218823
2. 修复任务文本翻译错误
...
## 4.5.0.PU.V1
1. 文本更新至4.5.0-live.10967244
2. 改进部分旧任务文本翻译

## 4.4.0.PU.V1
1. 文本更新至4.4.0-live.10744215
2. 为新版本及部分旧版本合约任务标题添加信息标注
3. 为npc添加标签方便区分npc与玩家
4. 修复部分已知文本错误
